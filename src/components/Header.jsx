...
import { Search, Bell, Menu, User, LogIn, Wallet, DollarSign, Sparkles, Settings, GraduationCap, CreditCard, Store, ShoppingBag, Smartphone } from 'lucide-react';
...
const GetAppPopover = () => <Popover>
        <PopoverTrigger asChild>
            <Button variant="ghost" size="icon" className="text-primary hover:text-primary hover:bg-primary/10" title="Get the App">
