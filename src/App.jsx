...
import AdminDailyDrop from '@/pages/admin/AdminDailyDrop';
  ...
  return (
    ...
    <ThemeProvider defaultTheme="dark" storageKey="homies-hub-theme">
        ...
        <Routes>
            ...
            <Route path="/admin/daily-drop" element={user?.isAdmin ? <AdminRouteWrapper><AdminDailyDrop /></AdminRouteWrapper> : <Navigate to="/admin/dashboard" />} />
